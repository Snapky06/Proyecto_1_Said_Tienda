...
// Inicio Producto Estrella
                        if (ventas_azucar > ventas_avena && ventas_azucar > ventas_trigo && ventas_azucar > ventas_maiz) {
                            ...
                            System.out.println("| El Producto Estrella Es : Maiz");
                                ...
                                || (ventas_azucar == ventas_trigo && ventas_azucar > ventas_avena && ventas_azucar > ventas_maiz)
                                || (ventas_azucar == ventas_maiz && ventas_azucar > ventas_avena && ventas_azucar > ventas_trigo)
                                || (ventas_avena == ventas_trigo && ventas_avena > ventas_azucar && ventas_avena > ventas_maiz)
                                || (ventas_avena == ventas_maiz && ventas_avena > ventas_azucar && ventas_avena > ventas_trigo)
                                || (ventas_trigo == ventas_maiz && ventas_trigo > ventas_azucar && ventas_trigo > ventas_avena)) {
